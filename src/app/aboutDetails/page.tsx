    ...
    return (
        <Container>
            <Box mt={4} mb={4} mx={4}>
                ...
                <Typography variant="body1" paragraph sx={{fontSize: "20px"}}>
                    I have actively participated in numerous seminars at both national and state levels, enhancing my knowledge and skills. With extensive experience in treating a wide range of acute and chronic conditions, including kidney stones, thyroid disorders, gynecological diseases, skin diseases, tumors, and cysts, etc.. I am dedicated to providing effective Homoeopathic care to my patients.
                </Typography>
            </Box>
        </Container>
    );
